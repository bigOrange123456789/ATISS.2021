...
# python generate_scenes.py ../config/bedrooms_config_lzc.yaml ../../Dataset/generate_out ../../Dataset/out-pickle/threed_future_model_bedroom.pkl ../../Dataset/3D-FRONT-texture --weight_file ../../Dataset/out-train/W1FYCHVEI/model_00000
